...
.inkhub-root pre { background-color: #1a1b26; border: 1px solid #2a2d3e; border-radius: 8px; color: #c0caf5; line-height: 1.72; margin: 26px 0; overflow-wrap: break-word; padding: 18px; tab-size: 4; white-space: pre-wrap; }
