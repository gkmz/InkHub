...
func TestDashboardGroupsCurrentWorkspaceWithoutDuplicates(t *testing.T) {
	...
	assertDashboardIDs(t, view.ReadyToPublish, "approved")
	assertDashboardIDs(t, view.RecentlyHandled, "published")
...
func TestDashboardLimitsRecentlyHandledByHandlingTime(t *testing.T) {
	...
	for index := 0; index < 11; index++ {
		...
		_, err := api.db.Exec(`INSERT INTO articles(id,workspace_id,source_id,stable_id,relative_path,title,content_hash,indexed_at,created_at,updated_at,source_mtime,content_stage) VALUES(?,?,?,?,?,?,?,'2026-07-31','2026-07-31','2026-07-31','2026-07-31','ready')`, id, "w2", "s2", id, id+".md", id, id+"-hash")
		if err != nil {
			t.Fatal(err)
		}
		...
		if _, err := api.db.Exec(`INSERT INTO article_dispositions(article_id,workspace_id,kind,content_hash,created_at,updated_at) VALUES(?,'w2','published',?,'2026-07-31',?)`, id, id+"-hash", handledAt); err != nil {
			t.Fatal(err)
		}
	}
...
INSERT INTO articles(id,workspace_id,source_id,stable_id,relative_path,title,content_hash,indexed_at,created_at,updated_at,source_mtime,content_stage,deleted_at) VALUES
('old','w1','s1','old','old.md','旧文章','old','2026-07-01','2026-07-01','2026-07-01','2026-07-31T14:00:00Z','ready',NULL),
('ignored','w2','s2','ignored','ignored.md','忽略','i2','2026-07-30','2026-07-30','2026-07-30','2026-07-30T14:00:00Z','ready',NULL),
('failed-published','w2','s2','failed-published','failed-published.md','部分渠道失败','fp1','2026-07-30','2026-07-30','2026-07-30','2026-07-30T13:00:00Z','ready',NULL),
('failed','w2','s2','failed','failed.md','失败','f1','2026-07-30','2026-07-30','2026-07-30','2026-07-30T12:00:00Z','ready',NULL),
('outdated','w2','s2','outdated','outdated.md','渠道过期','o2','2026-07-30','2026-07-30','2026-07-30','2026-07-30T11:00:00Z','ready',NULL),
('stale','w2','s2','stale','stale.md','外部发表已过期','s2','2026-07-30','2026-07-30','2026-07-30','2026-07-30T10:00:00Z','ready',NULL),
('changed','w2','s2','changed','changed.md','内容更新','c2','2026-07-30','2026-07-30','2026-07-30','2026-07-30T09:00:00Z','ready',NULL),
('pending','w2','s2','pending','pending.md','待审核','p1','2026-07-30','2026-07-30','2026-07-30','2026-07-30T08:00:00Z','ready',NULL),
('published','w2','s2','published','published.md','已发表','x1','2026-07-30','2026-07-30','2026-07-30','2026-07-30T07:00:00Z','ready',NULL),
('approved','w2','s2','approved','approved.md','已审核','a1','2026-07-30','2026-07-30','2026-07-30','2026-07-30T06:00:00Z','ready',NULL),
('deleted','w2','s2','deleted','deleted.md','已删除','d1','2026-07-30','2026-07-30','2026-07-30','2026-07-30T15:00:00Z','ready','2026-07-30');
