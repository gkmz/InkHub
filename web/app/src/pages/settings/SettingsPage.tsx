...
export function SettingsPage() {
  ...
  const refreshDiagnostics = async () => {
    ...
    try {
      ...
      setDiagnosticStatus("诊断已更新");
    } catch (reason) {
      setDiagnosticStatus(reason instanceof Error ? reason.message : "重新诊断失败");
    } finally {
      setDiagnosing(false);
    }
  };
