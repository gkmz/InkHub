...
const demoAPI: Plugin = {
  ...
  configureServer(server) {
    server.middlewares.use("/api/v1", (request, response) => {
      ...
      else if (url.pathname === "/settings") body = { workspace_name: "我的写作空间", vault_path: "/Users/me/Documents/Writing", content_roots: ["Areas"], ignored_folders: ["Areas/私人记录"], directories: [{ path: "Areas", markdown_count: 42 }, { path: "Areas/私人记录", markdown_count: 8 }], ai_enabled: true, ai_secret_saved: true, hugo_enabled: true, wechat_enabled: true, wechat_secret_saved: false, default_template: "default", templates: [{ id: "default", name: "InkHub Default", version: "1.0.0", compatible: true }, { id: "minimal", name: "InkHub Minimal", version: "1.0.0", compatible: true }], diagnostics: [{ name: "Obsidian Vault", state: "正常", message: "路径可读，已建立索引" }, { name: "Hugo CLI", state: "正常", message: "0.163.3 extended" }, { name: "图片托管", state: "未启用", message: "含本地图片的微信内容将无法准备" }] };
